package com.github.salilvnair.wordprocessor.constant;

public final class WordProcessorConstant {

	private WordProcessorConstant() {}
	
    public static final String WORD_FILE_TYPE_DOC = ".doc";
